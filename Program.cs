...
int number = InputInt("Введите число, до которого выдадим кубы целых чисел: ");  //запуск функции ввода числа number

for (int i = 1; i <= number; i++)   //у цикла for Три параметра: 1- инициализация, 2 - условие продолжение, 3 - команда в конце каждого цикла
{
    int square = i * i * i;              //заводим переменную = квадрату счетчика
